...
if(tdrLoggedIn()){	
	...
	<div class="container-fluid">
        ...
        <div style="border-radius:10px; margin-top:10px; padding:5px 50px;">
        	<input type="button" class="btn btn-success" value="New Trade" onclick="$('#back').load('newtrade.php',function(responseTxt, statusTxt, xhr){if(statusTxt == 'success'){ $('#back').show(); ch_contract(); $('.container').show();} if(statusTxt == 'error') alert('Error: ' + xhr.status + ': ' + xhr.statusText);});" style="margin-right:10px;">
    ...
    <script>
      ...
      $(document).on("dblclick", ".record_row", function (){
          ...
          //alert(did);
          //alert();
          $('#back').load('newtrade.php?id='+did,function(responseTxt, statusTxt, xhr){if(statusTxt == 'success'){ $('#back').show(); ch_contract(); $('.container').show();} if(statusTxt == 'error') alert('Error: ' + xhr.status + ': ' + xhr.statusText);});
          //code here
      });
      
      //$('#back').load('newtrade.php',function(responseTxt, statusTxt, xhr){if(statusTxt == 'success'){ $('#back').show(); ch_contract(); $('.container').show();} if(statusTxt == 'error') alert('Error: ' + xhr.status + ': ' + xhr.statusText);});
