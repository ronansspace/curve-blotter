...
?>
       ...
       <header>
        ...
        <div class="controls-div">
            <div class="btn-group" data-toggle="buttons">
                <input type="button" class="btn btn-primary btn-sm record_new" value="New Brokerage" style="margin-right:0px;">
                <input type="button" class="btn btn-danger btn-sm record_delete" value="Delete Brokerage" style="margin-right:5px;">
            </div>
        </div>
    ...
    <script>
          ...
          if(checkedVals.join(",") == ""){
                ...
                return false;
                   ...
                   if ($('.check_box:checkbox:checked').length > 1) {                            
                          ...
                          if (confirm('Delete Brokerage ?')) {                                      
                         
                                //var id_contract = sThisVal;
                                $.ajax({
                                        
                                        url: 'process/brokerage_delete.php?id_contract=' + checkedVals,
                                        dataType: 'json',
                                        success: function(s){                          
      ...
      function save_user_close(){  
          ...
          $.ajax({
                ...
                url: "process/brokerage_store.php?id_user="+$("#id_user").val(),
    ...
    $(document).on("dblclick", ".record_row", function (){
              ...
              $('#back').load('newbrokerage.php?id='+did,function(responseTxt, statusTxt, xhr){if(statusTxt == 'success'){ 
