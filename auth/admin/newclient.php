          ...
          <table class="table" border="0">                	
            <tbody>     
              ...
              <tr>                        	
                  ...
                  <td>Email</td>
                  <td>
                      <input tabindex="3" type="text" name="email" value="<?=$email;?>" class="">
                  </td>
                  -->                            
              ...
              <tr>  
                  ...
                  <td>		                             
                      <select tabindex="4" name="super_admin">								                             
                        <option <?php if(isset($super_admin) && $super_admin == "0" || $super_admin == ""){ echo "selected"; }?> value="0">N</option> 						 												    
                        <option <?php if(isset($super_admin) && $super_admin == "1"){ echo "selected"; }?> value="1">Y</option>   												    
                      </select>
                  </td>
                  -->                                     
              </tr>  
