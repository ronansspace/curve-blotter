...
//$value_date = date('d/m/Y', strtotime("+2 days"));
$matching_date = date('d/m/Y');
//$fixing_date = date('d/m/Y', strtotime("-2 days"));
...
if(isset($_GET['id'])){
    ...
    $client = $row['client'];
		...
		$Notional = number_format($row['Notional'], 2, '.', ','); //str_replace(' ','&nbsp;',htmlentities($row['Notional']));
		$ccy_pair = str_replace(' ','&nbsp;',htmlentities($row['ccy_pair']));
		$p_c = str_replace(' ','&nbsp;',htmlentities($row['p_c']));
		
    if($row['counter_amt'] <> ""){ 
      $counter_amt = number_format($row['counter_amt'], 2, '.', ','); //str_replace(' ','&nbsp;',htmlentities($row['counter_amt']));
		}
    $expiry_date = str_replace(' ','&nbsp;',htmlentities($row['expiry_date']));
		...
		$price = number_format($row['price'], 2, '.', ','); //str_replace(' ','&nbsp;',htmlentities($row['price']));
		if($row['rate'] <> ""){ 
        $rate = number_format($row['rate'], 2, '.', ','); //str_replace(' ','&nbsp;',htmlentities($row['rate']));
    }
		$prem_amt = number_format($row['prem_amt'], 2, '.', ','); //str_replace(' ','&nbsp;',htmlentities($row['prem_amt']));
		//$prem_ccy = str_replace(' ','&nbsp;',htmlentities($row['prem_ccy']));
		...
		$rebate_ccy = number_format($row['rebate_ccy'], 2, '.', ','); //str_replace(' ','&nbsp;',htmlentities($row['rebate_ccy']));
    ...
    if($row['rebate_amt'] <> ""){
		      $rebate_amt = number_format($row['rebate_amt'], 2, '.', ','); //str_replace(' ','&nbsp;',htmlentities($row['rebate_amt']));
    }
    
		if($row['payout_ccy'] <> ""){
          $payout_ccy = number_format($row['payout_ccy'], 2, '.', ','); // str_replace(' ','&nbsp;',htmlentities($row['payout_ccy']));
    }
    ...
    if($row['mid_price'] <> ""){ 
          $mid_price = number_format($row['mid_price'], 2, '.', ','); //$row['mid_price']; 
    }   
    ...
    if($row['premium_amount'] <> ""){
       $premium_amount =  number_format($row['premium_amount'], 2, '.', ','); //$row['premium_amount']; 
    }
    $calculations = $row['calculations']; 
    if($row['price_percentage'] <> ""){
      $price_percentage = number_format($row['price_percentage'], 2, '.', ','); //$row['price_percentage'];
    } 
    if($row['strike'] <> ""){
          $strike =  number_format($row['strike'], 2, '.', ',');
    }
...
?>
<style>		#FXSP,#FXFW,#FXNDF,#FXOPT,#EOPT{ 			display:none; 		} 		
          div.container{ 			
          ...
          div.top{background-color:#101010; padding-top:4px; padding-bottom:5px;} 		label.lb-left{ 			padding:3px 12px; color:#fff; background-color:#5E94DD;border-top-right-radius: 0em;border-bottom-right-radius: 0em; 		} 		label.lb-right{ 			background-color:#fff;padding:3px 12px; color:#101010;border-top-left-radius: 0em;border-bottom-left-radius: 0em; margin-right:20px; 		} 		label.lb-right select{ 			border:none; outline:none; min-width:70px; 		} 		td select,td input[type="text"],td input[type="date"]{ 			width:135px; 		} 		td input[type="text"],td input[type="date"]{ line-height:90%;} 		td input[type="date"]{ height:90%;} 		td{ white-space:nowrap;}          .col-md-12 {padding-right:0px;}     .table>tbody>tr>td{       padding: 6px;       padding-left: 5px;       line-height: 1;       vertical-align: middle;       border-top: 1px solid #ddd;     }     .table{             margin-top: 20px;     }     
</style>    
<div class="container form_drag" style="overflow:auto;">	
            ...
            <tbody>                    	
              <tr>                        	<td>Client:</td><td>
                  <select name="client" tabindex="1">                                        
                    <option <?php if(isset($client) && $client == ""){ echo "selected"; }?> value="">Select Client
                    </option>                            						
                    <option <?php if(isset($client) && $client == "ALSTRA-G/U RBS"){ echo "selected"; }?> value="ALSTRA-G/U RBS">ALSTRA-G/U RBS
                    </option>                                        
                    <option <?php if(isset($client) && $client == "BALDR-G/U RBS"){ echo "selected"; }?> value="BALDR-G/U RBS">BALDR-G/U RBS   
                    </option>                                        
                    <option <?php if(isset($client) && $client == "Bank of America Client"){ echo "selected"; }?> value="Bank of America Client">Bank of America Client
                    </option>                                        
                    <option <?php if(isset($client) && $client == "Bank of America EB"){ echo "selected"; }?> value="Bank of America EB">Bank of America EB
                    </option>                                        
                    <option <?php if(isset($client) && $client == "Barclays Bank Plc Client"){ echo "selected"; }?>  value="Barclays Bank Plc Client">Barclays Bank Plc Client
                    </option>                                        
                    <option <?php if(isset($client) && $client == "Barclays Bank Plc EB"){ echo "selected"; }?>  value="Barclays Bank Plc EB">Barclays Bank Plc EB
                    </option>                                        
                    <option <?php if(isset($client) && $client == "BNP Paribas Client"){ echo "selected"; }?>  value="BNP Paribas Client">BNP Paribas Client
                    </option>                                        
                    <option <?php if(isset($client) && $client == "BNP Paribas EB"){ echo "selected"; }?>  value="BNP Paribas EB">BNP Paribas EB
                    </option>                                        
                    <option <?php if(isset($client) && $client == "CAPSTONE- G/U Client"){ echo "selected"; }?>  value="CAPSTONE- G/U Client">CAPSTONE- G/U Client
                    </option>                                        
                    <option <?php if(isset($client) && $client == "CAPSTONE- G/U DB"){ echo "selected"; }?>  value="CAPSTONE- G/U DB">CAPSTONE- G/U DB
                    </option>                                        
                    <option <?php if(isset($client) && $client == "CitiGroup Client"){ echo "selected"; }?>  value="CitiGroup Client">CitiGroup Client
                    </option>                                        
                    <option <?php if(isset($client) && $client == "CitiGroup EB"){ echo "selected"; }?>  value="CitiGroup EB">CitiGroup EB
                    </option>                                        
                    <option <?php if(isset($client) && $client == "Credit Agricole  Client"){ echo "selected"; }?>  value="Credit Agricole  Client">Credit Agricole  Client
                    </option>                                        
                    <option <?php if(isset($client) && $client == "Credit Agricole  EB"){ echo "selected"; }?>  value="Credit Agricole  EB">Credit Agricole  EB
                    </option>                                        
                    <option <?php if(isset($client) && $client == "Credit Suisse AG Client"){ echo "selected"; }?>  value="Credit Suisse AG Client">Credit Suisse AG Client
                    </option>                                        
                    <option <?php if(isset($client) && $client == "Credit Suisse AG EB"){ echo "selected"; }?>  value="Credit Suisse AG EB">Credit Suisse AG EB
                    </option>                                        
                    <option <?php if(isset($client) && $client == "CURVE_MP"){ echo "selected"; }?>  value="CURVE_MP">CURVE_MP
                    </option>                                        
                    <option <?php if(isset($client) && $client == "Goldman Sachs  Client"){ echo "selected"; }?>  value="Goldman Sachs  Client">Goldman Sachs  Client
                    </option>                                        
                    <option <?php if(isset($client) && $client == "Goldman Sachs  EB"){ echo "selected"; }?>  value="Goldman Sachs  EB">Goldman Sachs  EB
                    </option>                                        
                    <option <?php if(isset($client) && $client == "GRATICULE- G/U Client"){ echo "selected"; }?>  value="GRATICULE- G/U Client">GRATICULE- G/U Client
                    </option>                                        
                    <option <?php if(isset($client) && $client == "GRATICULE- G/U DB"){ echo "selected"; }?>  value="GRATICULE- G/U DB">GRATICULE- G/U DB
                    </option>                                        
                    <option <?php if(isset($client) && $client == "HSBC Plc Client"){ echo "selected"; }?>  value="HSBC Plc Client">HSBC Plc Client
                    </option>                                        
                    <option <?php if(isset($client) && $client == "HSBC Plc EB"){ echo "selected"; }?>  value="HSBC Plc EB">HSBC Plc EB
                    </option>                                        
                    <option <?php if(isset($client) && $client == "ICBC Standard  Bank Plc Client"){ echo "selected"; }?> value="ICBC Standard  Bank Plc Client">ICBC Standard  Bank Plc Client
                    </option>                                        
                    <option <?php if(isset($client) && $client == "ICBC Standard Bank Plc EB"){ echo "selected"; }?>  value="ICBC Standard Bank Plc EB">ICBC Standard Bank Plc EB
                    </option>                                        
                    <option <?php if(isset($client) && $client == "JP Morgan NA Client"){ echo "selected"; }?>  value="JP Morgan NA Client">JP Morgan NA Client
                    </option>                                        
                    <option <?php if(isset($client) && $client == "JP Morgan NA EB"){ echo "selected"; }?>  value="JP Morgan NA EB">JP Morgan NA EB
                    </option>                                        
                    <option <?php if(isset($client) && $client == "LDF- G/U JPM"){ echo "selected"; }?>  value="LDF- G/U JPM">LDF- G/U JPM
                    </option>                                        
                    <option <?php if(isset($client) && $client == "LSF- G/U JPM"){ echo "selected"; }?>  value="LSF- G/U JPM">LSF- G/U JPM
                    </option>                                        
                    <option <?php if(isset($client) && $client == "MKP- G/U CITI"){ echo "selected"; }?>  value="MKP- G/U CITI">MKP- G/U CITI
                    </option>                                        
                    <option <?php if(isset($client) && $client == "MKP- G/U CITI Client"){ echo "selected"; }?>  value="MKP- G/U CITI Client">MKP- G/U CITI Client
                    </option>                                        
                    <option <?php if(isset($client) && $client == "Morgan Stanley Int Client"){ echo "selected"; }?>  value="Morgan Stanley Int Client">Morgan Stanley Int Client
                    </option>                                        
                    <option <?php if(isset($client) && $client == "Morgan Stanley Int EB"){ echo "selected"; }?>  value="Morgan Stanley Int EB">Morgan Stanley Int EB
                    </option>                                        
                    <option <?php if(isset($client) && $client == "NAB Client"){ echo "selected"; }?>  value="NAB Client">NAB Client
                    </option>                                        
                    <option <?php if(isset($client) && $client == "NAB EB"){ echo "selected"; }?>  value="NAB EB">NAB EB
                    </option>                                        
                    <option <?php if(isset($client) && $client == "Natixis Client"){ echo "selected"; }?>  value="Natixis Client">Natixis Client
                    </option>                                        
                    <option <?php if(isset($client) && $client == "Natixis EB"){ echo "selected"; }?>  value="Natixis EB">Natixis EB
                    </option>                                        
                    <option <?php if(isset($client) && $client == "Nomura Client"){ echo "selected"; }?>  value="Nomura Client">Nomura Client
                    </option>                                        
                    <option <?php if(isset($client) && $client == "Nomura EB"){ echo "selected"; }?>  value="Nomura EB">Nomura EB
                    </option>                                        
                    <option <?php if(isset($client) && $client == "OMEGA-G/U JPM"){ echo "selected"; }?>  value="OMEGA-G/U JPM">OMEGA-G/U JPM
                    </option>                                        
                    <option <?php if(isset($client) && $client == "OPERA- G/U DB"){ echo "selected"; }?>  value="OPERA- G/U DB">OPERA- G/U DB
                    </option>                                        
                    <option <?php if(isset($client) && $client == "PERMAL- G/U JPM"){ echo "selected"; }?>  value="PERMAL- G/U JPM">PERMAL- G/U JPM
                    </option>                                        
                    <option <?php if(isset($client) && $client == "PRELUDE- G/U JPM"){ echo "selected"; }?>  value="PRELUDE- G/U JPM">PRELUDE- G/U JPM
                    </option>                                        
                    <option <?php if(isset($client) && $client == "PROLOGUE- G/U JPM"){ echo "selected"; }?>  value="PROLOGUE- G/U JPM">PROLOGUE- G/U JPM
                    </option>                                        
                    <option <?php if(isset($client) && $client == "Prologue Mapplewood G/U JPM"){ echo "selected"; }?>  value="Prologue Mapplewood G/U JPM">Prologue Mapplewood G/U JPM
                    </option>                                        
                    <option <?php if(isset($client) && $client == "RBC  Client"){ echo "selected"; }?>  value="RBC  Client">RBC  Client
                    </option>                                        
                    <option <?php if(isset($client) && $client == "RBC  EB"){ echo "selected"; }?>  value="RBC  EB">RBC  EB
                    </option>                                        
                    <option <?php if(isset($client) && $client == "RBS Client"){ echo "selected"; }?>  value="RBS Client">RBS Client
                    </option>                                        
                    <option <?php if(isset($client) && $client == "RBS EB"){ echo "selected"; }?>  value="RBS EB">RBS EB
                    </option>                                        
                    <option <?php if(isset($client) && $client == "RESILIENCE- G/U UBS"){ echo "selected"; }?>  value="RESILIENCE- G/U UBS">RESILIENCE- G/U UBS
                    </option>                                        
                    <option <?php if(isset($client) && $client == "SEB Client"){ echo "selected"; }?>  value="SEB Client">SEB Client
                    </option>                                        
                    <option <?php if(isset($client) && $client == "SEB EB"){ echo "selected"; }?>  value="SEB EB">SEB EB
                    </option>                                        
                    <option <?php if(isset($client) && $client == "Standard Chartered  Client"){ echo "selected"; }?>  value="Standard Chartered  Client">Standard Chartered  Client
                    </option>                                        
                    <option <?php if(isset($client) && $client == "Standard Chartered  EB"){ echo "selected"; }?>  value="Standard Chartered  EB">Standard Chartered  EB
                    </option>                                        
                    <option <?php if(isset($client) && $client == "State Street Client"){ echo "selected"; }?>  value="State Street Client">State Street Client
                    </option>                                        
                    <option <?php if(isset($client) && $client == "State Street EB"){ echo "selected"; }?>  value="State Street EB">State Street EB
                    </option>                                        
                    <option <?php if(isset($client) && $client == "UBS AG Client"){ echo "selected"; }?>  value="UBS AG Client">UBS AG Client
                    </option>                                        
                    <option <?php if(isset($client) && $client == "UBS AG EB"){ echo "selected"; }?>  value="UBS AG EB">UBS AG EB
                    </option>                                        
                    <option <?php if(isset($client) && $client == "Westpac  Client"){ echo "selected"; }?>  value="Westpac  Client">Westpac  Client
                    </option>                                        
                    <option <?php if(isset($client) && $client == "Westpac EB"){ echo "selected"; }?>  value="Westpac EB">Westpac EB
                    </option>                            					
                  </select></td>                        	
                  <td>Rate:</td><td>
                  <input tabindex="5" id="fxsp_rate" class="fxsp_rate all_numbers" type="text" name="rate" value="<?=$rate;?>"></td>                            
                  <td>Trade Date:</td><td>
              ...
              <tr>                        	
                  ...
                  <input type="text" id="fxsp_vd" placeholder="dd/mm/yy" tabindex="9"   class="all_dates" name="value_date" value="<?=$value_date;?>"></td>                            <td>SPCUT:</td><td>                                  
              ...
              <tr>                        	<td></td><td>
                  ...
                  <input name="fx_pair_id" disabled value="fxp_123" value="<?=$fx_pair_id;?>" type="text"></td>                        
              </tr>                        
          ...
          <table class="table" border="0">	                 	
            <tbody>                    	
              ...
              <tr>                        	<td>Client:</td><td>
                  ...
                  </select></td>                        	  <td>Rate:</td><td>
                  <input tabindex="5" id="fxsp_rate" class="fxfw_rate all_numbers" type="text" name="rate" value="<?=$rate;?>" onBlur="$('#fxsp_camt').val(parseInt($('#fxsp_not').val().replace(/,/g,'')) * parseFloat($('#fxsp_rate').val()));"></td>                            <td>Trade Date:</td><td>
          ...
          <table class="table" border="0">                	
            <tbody>                    	  
              <tr>                        	<td>Client:</td><td>
                  ...
                  <input tabindex="6" id="fxsp_rate" class="fxndf_rate all_numbers" type="text" name="rate" value="<?=$rate;?>" onBlur="$('#fxsp_camt').val(parseInt($('#fxsp_not').val().replace(/,/g,'')) * parseFloat($('#fxsp_rate').val()));"></td>                            <td>Trade Date:</td><td>
          ...
          <table class="table" border="0">                	
            <tbody>                    	
              <tr>                        	<td>Client:</td><td>
                  ...
                  </select></td>                        	<td></td><td></td>                            <td>Trade Date:</td><td>
              ...
              <tr>                        	
                  ...
                  <td></td><td></td>                            <td>Traded As:</td><td>                                  
              ...
              <tr>                        	
                  ...
                  <td>FX_PAIR ID:</td>
                  <td><input name="fx_pair_id" disabled value="fxp_123" value="<?=$fx_pair_id;?>" type="text"></td>                        
              </tr>                        
              <tr>                                                	
              <td>
                  <select style="display:none;" tabindex="5" name="inverted">                            
              ...
              <tr>            							
                  ...
                  <input type="text" tabindex="4" class="all_dates" name="expiry_date" value="<?=$expiry_date;?>" onchange=" var nd =  $('#fxopt_exp').val().split('/'); var nd = new Date(nd[2] + '/'+nd[1]+'/'+nd[0]);nd.setDate(nd.getDate()+2); $('#fxopt_st').val($.datepicker.formatDate('dd/mm/yy',nd));"></td>            							
                    ...
                    -->            							
                    <!--<td>Premium CCY:</td><td><input type="text" value="<?=$premium_ccy;?>" name="premium_ccy" id="fxopt_premccy"></td>-->            							<td></td><td></td>            						
              </tr>                        
              <tr>                        	  
                  <td>Settelment:</td><td>
                  <input  class="all_dates notional_sprelast" tabindex="5" type="text" value="<?=$settle_date;?>" name="settle_date"></td>                            <td>Notional:</td><td>
              ...
              <tr>                        	
                  ...
                  <select name="option_style" tabindex="20">                                  
                    ...
                    <option <?php if(isset($option_style) && $option_style == "European"){ echo "selected"; }?> >European
                    </option>
                  </select>                            
                  </td>                            
                  <td></td>                            
  ...
  <div class="row" style="margin-top:10px;">
    <style>input[type="button"]{margin-right:15px;}
    </style>    	
    ...
    <input type="button" style="<?=$two_button;?>" class="btn btn-success btn-sm amend_button" value="Amend">  
...
<script>
	   ...
	   $(document).ready(function(){  
          ...
          $('.strike_last').keydown( function(e) {
              var key = e.charCode ? e.charCode : e.keyCode ? e.keyCode : 0;
              if(key == 13) {
                  $(".notional_last").focus();                  
              }
              if(key == 9) {                  
                  $(".notional_prelast").focus();
                  $('.ui-datepicker').hide();
              }
          });
          
          $('.strike_slast').keydown( function(e) {
              var key = e.charCode ? e.charCode : e.keyCode ? e.keyCode : 0;
              if(key == 13) {
                  $(".notional_slast").focus();            
              }
              if(key == 9) {
                  $(".notional_sprelast").focus();
                  $('.ui-datepicker').hide();
              }
          });
          
          $('#fxsp_not').keydown( function(e) {
         ...
         */ 
          ...
          $('.ccy_pair').on('change', function() {
               ...
               if($(this).val() == 'TRYJPY' || $(this).val() == 'TRYCZK' || $(this).val()== 'CADJPY'){ 
