...
?>
       ...
       <header>
        ...
        <div class="controls-div">
            <div class="btn-group" data-toggle="buttons">
                ...
                <input type="button" class="btn btn-primary btn-sm record_new" value="New Client Trader" style="margin-right:0px;">
                <input type="button" class="btn btn-danger btn-sm record_delete" value="Delete Client Trader" style="margin-right:5px;">
    ...
    <script>
      ...
      function getrecord_max(){
            ...
            $.ajax({
                  ...
                  url: 'process/all_client_trader.php',
                  dataType: 'json',
                  success: function(s){ 
      ...
      $(document).on("click", ".record_new", function (){
              ...
              var page = "newclient.php";                     
              $('#back').load('newclient_trader.php',function(responseTxt, statusTxt, xhr){                          
          ...
          if(checkedVals.join(",") == ""){
                ...
                return false;
                   ...
                   if ($('.check_box:checkbox:checked').length > 1) {                            
                           // your code goes here
                           alert("Please choose only one user to perform delete.");
                           return false;                          
                    }else{    
                          ...
                          if (confirm('Delete Client ?')) {                                      
                                ...
                                $.ajax({
                                        ...
                                        url: 'process/client_trader_delete.php?id_client=' + checkedVals,
                                        dataType: 'json',
                                        success: function(s){                          
      ...
      function save_user_close(){  
          ...
          $.ajax({
                ...
                url: "process/client_trader_store.php?id_client="+$("#id_client").val(),
    ...
    $(document).on("dblclick", ".record_row", function (){
              ...
              $('#back').load('newclient_trader.php?id='+did,function(responseTxt, statusTxt, xhr){if(statusTxt == 'success'){ 
