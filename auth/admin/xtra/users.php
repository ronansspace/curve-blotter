...
?>
       ...
       <header>
        ...
        <div class="controls-div">
            <div class="btn-group" data-toggle="buttons">
                <input type="button" class="btn btn-primary btn-sm record_new" value="New User" style="margin-right:0px;">
                <input type="button" class="btn btn-danger btn-sm record_delete" value="Delete User" style="margin-right:5px;">
            </div>
        </div>
    ...
    <script>
      ...
      $(document).on("click", ".record_new", function (){
              ...
              var page = "newuser.php";                     
              $('#back').load('newuser.php',function(responseTxt, statusTxt, xhr){                          
                   ...
                   if ($('.check_box:checkbox:checked').length > 1) {                            
                          ...
                          if (confirm('Delete User ?')) {                                      
                                ...
                                $.ajax({
                                        ...
                                        url: 'process/user_delete.php?id_contract=' + checkedVals,
                                        dataType: 'json',
                                        success: function(s){                          
      ...
      function save_user_close(){  
          ...
          $.ajax({
                ...
                url: "process/user_store.php?id_user="+$("#id_user").val(),
    ...
    $(document).on("dblclick", ".record_row", function (){
              ...
              $('#back').load('newuser.php?id='+did,function(responseTxt, statusTxt, xhr){if(statusTxt == 'success'){ 
