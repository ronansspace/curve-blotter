...
?>
    ...
    <script>
      ...
      $(document).on("click", ".record_new", function (){
              ...
              $('#back').load('newclient.php',function(responseTxt, statusTxt, xhr){                          
                   ...
                   if ($('.check_box:checkbox:checked').length > 1) {                            
                          ...
                          if (confirm('Delete Client ?')) {                                      
                                ...
                                $.ajax({
                                        ...
                                        url: 'process/client_delete.php?id_client=' + checkedVals,
                                        dataType: 'json',
                                        success: function(s){                          
      ...
      function save_user_close(){  
          ...
          $.ajax({
                ...
                url: "process/client_store.php?id_client="+$("#id_client").val(),
    ...
    $(document).on("dblclick", ".record_row", function (){
              ...
              $('#back').load('newclient.php?id='+did,function(responseTxt, statusTxt, xhr){if(statusTxt == 'success'){ 
