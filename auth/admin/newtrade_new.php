...
if(isset($_GET['id'])){
    ...
    if($row["rebate_ccy"] <> "" || $row["rebate_ccy"] > 0){
            ...
            <tbody>                    	
              ...
              <tr>                        	
                  ...
                  <td colspan="4">
                      ...
                      ?>
                      <select class="delta_change" name="delta" tabindex="1">
                             
                       <option value="NO" <?php if($delta == "NO"){ print "selected"; } ?>>NO</option>
                       <option value="YES" <?php if($delta == "YES"){ print "selected"; } ?>>YES</option>
              ...
              <tr class="delta_text" style="display:<?=$delta_text_tr;?>">                        	
                  <td></td>
                  <td colspan=""></td>       
                  ...
                  <td>Delta Instr.:</td>
                  <td colspan="4">
                      <textarea name="delta_text" rows="3" style="width:100%"><?=$delta_text;?></textarea>
                  </td>           
              </tr>  
    ...
    <?php
     // IF product is EOPT 
              ...
              if($opt_type=="BARR"){
                  ...
                  $exotic_option_middle_barrier_bg = 'grey';
                	$exotic_option_rebate_ccy_bg = 'grey';
                	$exotic_option_rebate_amount_bg = 'grey';
                	
                  if(($barrier_type=="DO")||($barrier_type=="DI")){
                	   	   	$exotic_option_upper_barrier_bg='grey';                		      
                	}
                  
                	if(($barrier_type=="UO")||($barrier_type=="UI")){
                     
                	    $exotic_option_lower_barrier_bg = 'grey';
                  }
                
                
                	$exotic_option_touch_up_down_bg = 'grey';
                	$exotic_option_cash_at_bg = 'grey';
            ...
            if($opt_type=="DBAR"){
                  ...
                  $exotic_option_rebate_amount_bg ='grey';
                	...
                	$exotic_option_barrier_type_bg = 'grey';
                	$exotic_option_touch_up_down_bg='grey';
                	$exotic_option_cash_at_bg='grey';
                	$exotic_option_middle_barrier_bg='grey';
            ...
            if($opt_type=="DIGI"){
              		...
              		$exotic_option_knock_in_out_bg='grey';            
              		$option_put_call_ind_bg='grey';             
              		$strike_bg='grey';   
          ...
          <table class="table" border="0">                	
            <tbody>                    	
              ...
              <tr>                        	
                  ...
                  <td>Counter Amount:</td>
                  <td>
                      <input tabindex="" value="<?=$counter_amt;?>" name="counter_amt" id="fxeopt_camt"  class="fxopt_camt all_numbers" type="text">
                  </td>
              ...
              <tr>            							
                 ...
                 <td>
                        ...
                        <!--<input type="text" value="<?=$premium_ccy;?>" name="premium_ccy" id="fxopt_premccy">-->
                        <select id="fxeopt_premccy" name="premium_ccy"> 									
                          <option value="">
                          </option>
                          <option <?php if(isset($premium_ccy) && $premium_ccy == "AUD"){ echo "selected"; }?> value="AUD">AUD
                          </option>
              ...
              <tr>                        	  
                  <td>Settelment:</td><td>
                  <input tabindex="5" class="all_dates notional_prelast settle_date_class" type="text" value="<?=$settle_date;?>" name="settle_date"></td>                            
                  <td>Notional:</td><td>
                  <input type="text" name="notional" tabindex="15" class="notional_slast all_numbers"  value="<?=$Notional;?>" id="eopt_not"></td>                            
                  <td>Payout CCY:</td>
                  <td>
                        <input type="text" value="<?=$payout_ccy;?>" tabindex="26" name="payout_ccy" class="all_numbers" id="fxopt_payout">                  
                  </td>                            
                  <td></td><td></td>                        
              </tr>                        
              <tr>                        	
                  <td>Call/Put:</td><td>                          
                  <select name="spcut_cp" tabindex="6" id="option_put_call_ind" style="background-color:<?=$option_put_call_ind_bg;?>">                               
                    <option <?php if(isset($spcut_cp) && $spcut_cp == "Call"){ echo "selected"; }?> value="Call">C
                    </option>          										 
                    <option <?php if(isset($spcut_cp) && $spcut_cp == "Put"){ echo "selected"; }?> value="Put">P
                    </option>                               
                    <!--
										 <option <?php if(isset($spcut_cp) && $spcut_cp == "ECB"){ echo "selected"; }?> value="ECB">ECB</option>
										 <option <?php if(isset($spcut_cp) && $spcut_cp == "WMC"){ echo "selected"; }?> value="WMC">WMC</option>
              ...
              <tr>                        	  
                  <td>Strike:</td><td>
                      <input type="text" tabindex="7" value="<?=$strike;?>" class="strike_slast all_numbers" id="strike" style="background-color:<?=$strike_bg;?>" name="strike"></td>                            
                  <td style="color:#BF3739;">Premium amount:</td><td>
              ...
              <tr style="margin-top:15px;">                        	   
                  ...
                  <td>    
        					    ...
        					    <select name="opt_type" tabindex="8" id="exotic_option_type" style="background-color:<?=$exotic_option_type_bg;?>">  
                      		<option value=""></option>
            							<option <?php if(isset($opt_type) && $opt_type == "BARR"){ echo "selected"; }?> value="BARR">BARR</option>
            							<option <?php if(isset($opt_type) && $opt_type == "DBAR"){ echo "selected"; }?> value="DBAR">DBAR</option>							
            							<option <?php if(isset($opt_type) && $opt_type == "DDIG"){ echo "selected"; }?> value="DDIG">DDIG</option>
            							<option <?php if(isset($opt_type) && $opt_type == "DIGI"){ echo "selected"; }?> value="DIGI">DIGI</option>
            							<option <?php if(isset($opt_type) && $opt_type == "MBAR"){ echo "selected"; }?> value="MBAR">MBAR</option>
							        </select>
                      
                      <!--<input value="<?=$opt_type;?>" tabindex="8" name="opt_type" type="text">-->
                  
                  </td>                            
                  <td>Lower_Barrier:</td><td>
                  <input value="<?=$lower_barrier;?>" id="exotic_option_lower_barrier" style="background-color:<?=$exotic_option_lower_barrier_bg;?>" tabindex="18" name="lower_barrier" type="text"></td>                            
                  <td>Cash At:</td>                            
                  <td>                                  
                  <select name="cashat" tabindex="29" id="exotic_option_cash_at" style="background-color:<?=$exotic_option_cash_at_bg;?>">                                        
              ...
              <tr>                        	
                  ...
                  <td>
                          ...
                          <!--<input value="<?=$barrier_type;?>"  tabindex="9" name="barrier_type" type="text">-->
                          
                          <select name="barrier_type" tabindex="9" id="exotic_option_barrier_type" style="background-color:<?=$exotic_option_barrier_type_bg;?>">  
                          		<option value=""></option>
                							<option <?php if(isset($barrier_type) && $barrier_type == "UO"){ echo "selected"; }?> value="UO">UO</option>
                							<option <?php if(isset($barrier_type) && $barrier_type == "UI"){ echo "selected"; }?> value="UI">UI</option>							
                							<option <?php if(isset($barrier_type) && $barrier_type == "DO"){ echo "selected"; }?> value="DO">DO</option>
                							<option <?php if(isset($barrier_type) && $barrier_type == "DI"){ echo "selected"; }?> value="DI">DI</option>
    							        </select>
                          
                  </td>                            
                  <td>Knock&ndash;in&ndash;out(I/O):</td>
                  <td>
                          
                          <!--<input  value="<?=$knock_in_out;?>" name="knock_in_out" tabindex="19" type="text">-->
                          <select name="knock_in_out" tabindex="19" id="exotic_option_knock_in_out" style="background-color:<?=$exotic_option_knock_in_out_bg;?>">  
                          		<option value=""></option>
                							<option <?php if(isset($knock_in_out) && $knock_in_out == "I"){ echo "selected"; }?> value="I">I</option>
                							<option <?php if(isset($knock_in_out) && $knock_in_out == "O"){ echo "selected"; }?> value="O">O</option>
    							        </select>
                  
                  </td>                            
                  <td>Rebate_CCY:</td><td>
                  <input type="text" value="<?=$rebate_ccy;?>" class="all_numbers" tabindex="30" name="rebate_ccy" style="background-color:<?=$exotic_option_rebate_ccy_bg;?>" id="exotic_option_rebate_ccy"></td>                            
              ...
              <tr>                        	  
                  ...
                  <input  value="<?=$up_barrier;?>" id="exotic_option_upper_barrier" style="background-color:<?=$exotic_option_upper_barrier_bg;?>" name="up_barrier" tabindex="10" type="text"></td>                            
                  <td>Touch&ndash;up&ndash;down:</td>
                  <td>
                        <!--<input type="text"  value="<?=$touch_up_down;?>" tabindex="20" name="touch_up_down">-->
                        <select name="touch_up_down" tabindex="20" id="exotic_option_touch_up_down" style="background-color:<?=$exotic_option_touch_up_down_bg;?>">  
                          		<option value=""></option>
                							<option <?php if(isset($touch_up_down) && $touch_up_down == "U"){ echo "selected"; }?> value="U">U</option>
                							<option <?php if(isset($touch_up_down) && $touch_up_down == "D"){ echo "selected"; }?> value="D">D</option>
    							      </select>
                  </td>                            
                  <td>Rebate&nbsp;Amount:</td><td>
                  <input type="text" value="<?=$rebate_amt;?>" class="all_numbers" tabindex="31" name="rebate_amt" id="exotic_option_rebate_amount" style="background-color:<?=$exotic_option_rebate_amount_bg;?>"></td>                            
                  <td>Barrier&nbsp;Style:</td>                            
                  <td>                                
                      <select name="barrier_style" tabindex="40">          
                        ...
                        Counter %
                        -->                          
                        <option <?php if(isset($barrier_style) && $barrier_style == "American" || $barrier_style == ""){ echo "selected"; }?>>American</option>
                        <option <?php if(isset($barrier_style) && $barrier_style == "European"){ echo "selected"; }?>>European</option>                                
                      </select>                            
                  </td>                        
              </tr>                                                 
              <tr>                        
                  	<td>Middle Barrier:</td><td><input tabindex="11" id="exotic_option_middle_barrier" style="background-color:<?=$exotic_option_middle_barrier_bg;?>" name="mid_barrier" value="<?=$mid_barrier;?>"  type="text"></td>                        
              </tr>                    
            </tbody>                
          </table>				
        </form>            
	   ...
	   $(document).ready(function(){  
          ...
          $('.ccy_pair').on('change', function() {
               ...
               $('#fxsp_td').val($.datepicker.formatDate('dd/mm/yy',date)); 
                ...
                if(myform_only == "FXOPT" || myform_only == "EOPT"){
          ...
          $(document).on("change", ".delta_change", function (){
                     
                     var myform = $("#contract").val() + "_form";
                     var this_val = $("#" + myform).find("select[name=delta]").val();
                     
                     if(this_val == "YES"){
                         $("#" + myform).find(".delta_text").show();
                     }else{
                         $("#" + myform).find(".delta_text").hide();
                     }
          ...
          function call_sum_function(){
              ...
              strike_amt_val =  $("#" + myform).find(".strike_slast").val();
              notional_amt_val = $("#" + myform).find(".notional_slast").val();
              ...
              $("#" + myform).find("input[name=counter_amt]").val(total_strike_notional);  
