...
?>
    ...
    function expiry_date_opt_change(){
            ...
            var date2 = $("#" + myform).find('.expiry_date_opt').datepicker('getDate', '+1d');
            ...
            if(mthis_curr == "CAD" || mthis_curr == "TRY"){
                  ...
                  if(date2.getDay() == 6) {  date2.setDate(date2.getDate()+1);  }
                  ...
                  if(date2.getDay() == 6) {  date2.setDate(date2.getDate()+2);  }
                  if(date2.getDay() == 0) {  date2.setDate(date2.getDate()+2);  } 
    ...
    $(document).on('change', '.all_numbers_rate', function() {
          ...
          } else if( contract_val == "FXFW"  || contract_val == "FXSP" ){
    ...
    $(document).on('change', '.all_numbers', function() {
          ...
          if(contract_val == "FXNDF" || contract_val == "FXOPT" || contract_val == "EOPT") {                  
    ...
    /*
    function setbarriertype(){
  	     
         selected_index = document.getElementById("exotic_option_barrier_type").selectedIndex;
  	     document.getElementById("exotic_option_barrier_typehide").value=document.getElementById("exotic_option_barrier_type").options[selected_index].value;
         
    } 
    
    function ex_option_type(){
    
          selected_index = document.getElementById("exotic_option_type").selectedIndex;
      	  document.getElementById("exotic_option_typehide").value = document.getElementById("exotic_option_type").options[selected_index].text;
    
    }*/
    
    $(document).on("change", "#exotic_option_type, #exotic_option_barrier_type", barrier_type);
    
    function barrier_type(){
      
            //document.getElementById("newBarrierDate").style.display="inline";
            //document.getElementById("normalBarrierDate").style.display="none";
            
            if(document.getElementById("exotic_option_type").value=="BARR"){
            	
                  document.getElementById("exotic_option_middle_barrier").style.background='grey';
                	document.getElementById("exotic_option_rebate_ccy").style.background='grey';
                	document.getElementById("exotic_option_rebate_amount").style.background='grey';
                	document.getElementById("exotic_option_barrier_type").style.background='white';
                	
                  if((document.getElementById("exotic_option_barrier_type").value=="DO")||
                	   (document.getElementById("exotic_option_barrier_type").value=="DI")){
                	   	   	document.getElementById("exotic_option_upper_barrier").style.background='grey';
                		      document.getElementById("exotic_option_lower_barrier").style.background='white';
                	}
                  
                	if((document.getElementById("exotic_option_barrier_type").value=="UO")||
                	   (document.getElementById("exotic_option_barrier_type").value=="UI")){
                     
                	    document.getElementById("exotic_option_lower_barrier").style.background='grey';
                		  document.getElementById("exotic_option_upper_barrier").style.background='white';
                  }
                
                	if((document.getElementById("exotic_option_barrier_type").value=="DI")||
                	   (document.getElementById("exotic_option_barrier_type").value=="UI")){
                		  document.getElementById("exotic_option_knock_in_out").value="I";
                  }
                  
                	if((document.getElementById("exotic_option_barrier_type").value=="DO")||
                	   (document.getElementById("exotic_option_barrier_type").value=="UO")){
                  		document.getElementById("exotic_option_knock_in_out").value="O";
                  }
              
                	document.getElementById("exotic_option_touch_up_down").style.background='grey';
                	document.getElementById("exotic_option_cash_at").style.background='grey';
                  
                	document.getElementById("exotic_option_knock_in_out").style.background='white';
                	document.getElementById("option_put_call_ind").style.background='white';
              		document.getElementById("strike").style.background='white';
                
            }
            
            if(document.getElementById("exotic_option_type").value=="DBAR"){
              
                  document.getElementById("exotic_option_rebate_ccy").style.background='grey';
                  document.getElementById("exotic_option_rebate_amount").style.background='grey';
                
                	document.getElementById("exotic_option_barrier_type").style.background='grey';
                	document.getElementById("exotic_option_touch_up_down").style.background='grey';
                	document.getElementById("exotic_option_cash_at").style.background='grey';
                	document.getElementById("exotic_option_middle_barrier").style.background='grey';
                	document.getElementById("exotic_option_upper_barrier").style.background='white';
            ...
            if(document.getElementById("exotic_option_type").value=="MBAR"){
              ...
              document.getElementById("exotic_option_rebate_amount").style.background='grey';              
            	...
            	document.getElementById("exotic_option_upper_barrier").style.background='white';
            	document.getElementById("exotic_option_lower_barrier").style.background='white';
            	document.getElementById("exotic_option_middle_barrier").style.background='white';
            	document.getElementById("exotic_option_knock_in_out").style.background='white';
            	document.getElementById("option_put_call_ind").style.background='white';
            	document.getElementById("strike").style.background='white';
          	...
          	if(document.getElementById("exotic_option_type").value=="DDIG"){
                 
            			document.getElementById("exotic_option_barrier_type").style.background='grey';
            			document.getElementById("exotic_option_rebate_ccy").style.background='white';
            			document.getElementById("exotic_option_rebate_amount").style.background='white';
            			document.getElementById("exotic_option_lower_barrier").style.background='white';
            			document.getElementById("exotic_option_middle_barrier").style.background='grey';
            			document.getElementById("exotic_option_upper_barrier").style.background='white';
          				...
          				document.getElementById("option_put_call_ind").style.background='grey';
          				document.getElementById("strike").style.background='grey';          
          
          	}
	
            if(document.getElementById("exotic_option_type").value=="DIGI"){
          
                  document.getElementById("exotic_option_rebate_ccy").style.background='white';
                  document.getElementById("exotic_option_rebate_amount").style.background='white';
                
                	if((document.getElementById("exotic_option_barrier_type").value=="DI")||
                	   (document.getElementById("exotic_option_barrier_type").value=="DO")){
                		  document.getElementById("exotic_option_touch_up_down").value="D";
                  }
                	
                  if((document.getElementById("exotic_option_barrier_type").value=="UI")||
                	   (document.getElementById("exotic_option_barrier_type").value=="UO")){
                		  document.getElementById("exotic_option_touch_up_down").value="U";
                  }
                
              		document.getElementById("exotic_option_knock_in_out").style.background='grey';
                  document.getElementById("exotic_option_touch_up_down").style.background='white';              
              		document.getElementById("option_put_call_ind").style.background='grey';                 
              		document.getElementById("strike").style.background='grey';                  		
                
                	if(document.getElementById("exotic_option_touch_up_down").value=="U"){
                		document.getElementById("exotic_option_lower_barrier").style.background='grey';
                		document.getElementById("exotic_option_middle_barrier").style.background='grey';
                		document.getElementById("exotic_option_upper_barrier").style.background='white';
                  }
                
                	if(document.getElementById("exotic_option_touch_up_down").value=="D"){
                		document.getElementById("exotic_option_upper_barrier").style.background='grey';
                		document.getElementById("exotic_option_middle_barrier").style.background='grey';
                		document.getElementById("exotic_option_lower_barrier").style.background='white';
                  }
